  ...
  return (
    <footer id="footer">
      <div className="footer-top">
          ...
          {/* 중간 물결 */}
          <svg className="wave-svg mid" viewBox="0 0 1440 320" preserveAspectRatio="none">
            <path
              fill="#512b2b"
          ...
          <svg className="wave-svg second" viewBox="0 0 1440 250" preserveAspectRatio="none">
            <path
              fill="#512b2b"
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-inner">
          ...
          <div className="footer-logo">
            <img src="./images/footer/logo.png" alt="Jazz Myomyo" />
          </div>
        </div>
      </div>
