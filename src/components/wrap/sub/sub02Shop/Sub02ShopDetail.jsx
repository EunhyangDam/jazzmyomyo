...
function Sub02ShopDetail(props) {
  ...
  const toggleSections = ["교환 및 반품이 불가능한 경우", "반복 반품", "반품 방법", "환불"];
            ...
            <div className="bottom">
              <div className="description">
                ...
                state.product[0].이미지.map((img, index) => (
                  <img key={index} src={img} alt={`상품이미지 ${index + 1}`} />
                ))
                }
                </div>
              </div>
            ...
            <div className="delivery-box">
              <ul>
                ...
                delivery.delivery.map((item, idx) => {
                  ...
                  return (
                    <li key={idx} className={isToggleSection ? "plus" : "delivery"}>
                      ...
                      >
                        ...
                        {isToggleSection && (
                          <a href="#" className="icon" onClick={(e) => e.preventDefault()}>
                            {isOpen ? <i className="bi bi-dash"/> : <i className="bi bi-plus"/>}
                          </a>
                        )}
                      </div>
