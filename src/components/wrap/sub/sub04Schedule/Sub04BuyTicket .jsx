...
function Sub04BuyTicket(props) {
 ...
 // 탭 전환
  ...
  // 비회원 폼 입력
  const handleGuestNameChange  = (e) => setGuestForm({ ...guestForm, name:  e.target.value });
  const handleGuestPhoneChange = (e) => setGuestForm({ ...guestForm, phone: e.target.value });
  const handleGuestEmailChange = (e) => setGuestForm({ ...guestForm, email: e.target.value });
  ...
  // 공연 선택 (커리)
  const handleChoosePerformance = (item) => () => setSelectedPerformance({ ...item, date: selectedStr });
    ...
    calendarCells.push(
      ...
      >
        <span
          ...
          style={{
            color: weekday === 0 ? '#dd0000' : weekday === 6 ? '#003cff' : undefined,
          }}
        >
          {d}
        </span>
...
////// 예약 전송 //////////////////////////////////////
  ...
  const handleReserveClick = (e) => {
    ...
    const dateText = `${dateObj.getMonth() + 1}월 ${dateObj.getDate()}일 ${selectedPerformance.time.split('~')[0].trim()}`;
          ...
          <div className="contents">
            ...
            <div className="calendar-area">
              <div className="calendar-header">
                ...
                <div className="calendar-title">{(month + 1).toString().padStart(2, '0')}</div>
                <button
                ...
                {performancesToday.length === 0 ? (
                  ...
                  performancesToday.map((item, idx) => (
                    <div className="performance-card" key={idx}>
                      <div className="number">{(idx + 1).toString().padStart(2, '0')}</div>
        ...
        {selectedPerformance ? (
          <div className="time-confirm">
            ...
            <div className="buttons">
              <button
                className={`confirm-btn ${selected === 'yes' ? 'selected' : ''}`}
            ...
            <div className="container">
              ...
              <div className="content">
                <ul>
                  ...
                  <li>원활한 좌석배정을 위해 예약시간 15분 전까지 방문하시는걸 추천드립니다</li>
                  <li>연락없이 예약시간보다 15분 이상 늦으시면 좌석선택이 불가능 합니다. 꼭 사전에 연락주세요</li>
                  <div className="gap">
