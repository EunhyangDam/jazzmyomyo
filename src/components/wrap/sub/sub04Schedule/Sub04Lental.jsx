    ...
    <div id="sub04Lental">
      ...
      <header id="header">
        <div className="container">
          <div className="breadcrumb">
            <span className="home-icon"><i className="material-icons">home</i></span>
            <span>&gt;</span>
            <span>Schedule</span>
            <span>&gt;</span>
          ...
          <nav className="rental-scroll-nav" ref={navRef}>
            <ul>
              <li className="active"><a href="#rental-process">대관절차</a></li>
              <li><a href="#rental-fee">대관료</a></li>
              <li><a href="#rental-download">대관자료</a></li>
              <li><a href="#rental-apply">대관신청</a></li>
            </ul>
          </nav>
        </div>
      </header>
              ...
              <div className="mobile-process">
                <div className="step-box">
                  ...
                  <div className="step-content">
                    <h4>대관신청</h4>
                    <p>재즈묘묘 홈페이지에서 신청양식 다운로드 후 제출해주세요!</p>
                  </div>
                </div>
                <div className="step-box">
          ...
          <div className="info-box">
            ...
            <ul className="info-list">
              ...
              <li>
                ...
                <p>승인 여부 및 제출 필요 서류 개별 통보 (메일, 문자 또는 유선 통보)</p>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="fee-table">
            <div className="row header">
              <div className="time hour"><p>12:00 ~ 18:00</p></div>
              <div className="time hour"><p>18:00 ~ 23:00</p></div>
            </div>
            <div className="row price">
              <div className="time fee"><p>시간당</p><strong>40,000원</strong></div>
              <div className="time fee"><p>시간당</p><strong>60,000원</strong></div>
            </div>
          </div>
          <p className="fee-note">* 공연시간 내 대관은 추가비용이 있으니 문의 부탁드립니다</p>
          ...
          <div className="mobile-fee-table">
              <div className="fee-card">
                ...
                <div className="fee-price">시간당 <strong>40,000원</strong></div>
              </div>
              <div className="fee-card">
                <div className="fee-time">18:00 ~ 23:00</div>
                <div className="fee-price">시간당 <strong>60,000원</strong></div>
              </div>
              <p className="fee-note">* 공연시간 내 대관은 추가비용이 있으니 문의 부탁드립니다</p>
          </div>
            ...
            <ul>
              <li>
                  ...
                  <dl>
                      ...
                      <dd>쥰비 및 새팅, 장비 철수 및 장소 원상복구 시간은 계약 시간에 포함 되어있습니다</dd>
                      <dd>계약된 시간을 초과할 경우 추가 결제가 발생할 수 있습니다</dd>
                  </dl>
              </li>
              <li>
                  <strong>기본 대관료에 포함되는 내용</strong>
                  <dl>
                      <dd>피커 2대, 마이크 2대, 오디오믹서 1대 포함한 기본 음향 장비</dd>
                      <dd>스탠딩 조명 2개 (색상 조절 가능) 등의 간단한 무대 조명</dd>
                      <dd>간단한 공간 안내 및 세팅 지원 : 입장 전 10분 간 직원 간단한 세팅을 도와드립니다</dd>
                  </dl>
              </li>
              <li>
          ...
          <div className="caution-box">
            <h3>주의사항</h3>
            <ul>
              <li><p> 기본 항목외의 기타 장비 사용은  대관료에 포함되지 않으며, 필요 시 사전 협의 및 별도 비용 청구됩니다</p></li>
              <li><p> 현장 상황에 따라 추가 비용이 발생할 수 있으며, 사전 확인이 필수입니다.</p></li>
              <li><p> 세부 사항은 내부 대관규정에 따릅니다. 신청 전 반드시 대관규정을 확인하여 주시기 바랍니다. (대관규정은 대관신청서와 함께 다운로드 할 수 있습니다.)</p></li>
              <li><p> 행사장 내부 구조변경(책상/의자 등) 시 원상복구를 원칙으로 합니다.</p></li>
            </ul>
          </div>
        </div>
      </section>
              ...
              <div className="download-table">
                  <ul>
                      <li>
                          <dl>
                              <dd><p>공간도면</p></dd>
                              <dd><a href="#">공간도면 <i className="material-icons">insert_drive_file</i></a></dd>
                          </dl>
                      </li>
                      <li>
                          <dl>
                              <dd><p>대관 신청서</p></dd>
                              <dd><a href="#">대관 신청서 <i className="material-icons">insert_drive_file</i> </a></dd>
                          </dl>
                      </li>
                      <li>
                          <dl>
                              <dd><p>대관 규약</p></dd>
                              <dd><a href="#">대관 규약<i className="material-icons">insert_drive_file</i> </a></dd>
                          </dl>
                      </li>
                  </ul>
              </div>
      ...
      <section id="rental-apply" className="section4">
        <div className="container">
          ...
          <p className="apply-notice">대관신청 전 반드시 대관규약 확인 후 신청 바랍니다.</p>
          ...
          <div className="apply-box">
            ...
            <div className="contact-info">
              <h3>대관문의</h3>
              <ul>
                  <li><p>재즈묘묘 02-1223-4567</p></li>
                  <li><p>문의 가능 시간 11:00 ~ 18:00</p></li>
                  <li><p>(월, 화는 휴무입니다)</p></li>
                  <li><p>jazzmyomyo@gmail.com</p></li>
              </ul>
            </div>

            {/* <!-- 오른쪽 --> */}
              <form className="apply-form" action="#" method="POST" enctype="multipart/form-data">
                <div className="form-inner">
                  {/* <!-- 왼쪽 필드 영역 --> */}
                  <div className="form-fields">
                    <div className="form-group">
                      <label for="name">신청자정보</label>
                      <input type="text" id="name" name="name" placeholder="이름 및 단체명" required />
                    </div>
                    <div className="form-group">
