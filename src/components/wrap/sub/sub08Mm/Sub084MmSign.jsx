...
const DEFAULT_SETTING = {
  approval: "자동 승인",     // '자동 승인' | '관리자 승인'
  defaultGrade: "일반회원",  // '일반회원' | '단골회원'
  emailAgree: "Y",           // 'Y' | 'N'
};
        ...
        <main className="main">
          ...
          <div className="join-settings">
            ...
            <div className="form-group">
              <label htmlFor="approval">가입 승인 방식</label>
              <select
                id="approval"
                value={approval}
              ...
              >
                <option>자동 승인</option>
                <option>관리자 승인</option>
              </select>
            </div>

            {/* 기본 회원 등급 */}
            <div className="form-group">
              <label htmlFor="defaultGrade">기본 회원 등급</label>
              <select
                id="defaultGrade"
                value={defaultGrade}
