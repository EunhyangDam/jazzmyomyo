...
import "./scss/Sub07AddressListCreate.scss";
...
function Sub07AddressListCreate(props) {
  ...
  const onSubmitAddAddress = (e) => {
    e.preventDefault();
    const {
       아이디, 기본배송지, 메모, 이름, 연락처,  배송요청, 우편번호, 주소1, 주소2
      } = state;
    ...
    formData.append("deliveryDefault", Number(기본배송지));
    formData.append("memo", 메모);
    formData.append("recipient", 이름);
    formData.append("deliveryHp", 연락처);
    ...
    axios({
      url: "/jazzmyomyo/delivery_table_insert.php",
      method: "POST",
      data: formData,
    })
      .then((res) => {
        ...
        <div className="content">
          ...
          <div className="address-box">
            <form autoComplete="off" onSubmit={onSubmitAddAddress}>
              ...
              <div className="foot">
                <button onClick={onClickCancelEdit}>작성 취소</button>
...
export default Sub07AddressListCreate;
