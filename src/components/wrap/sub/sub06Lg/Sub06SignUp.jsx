...
function Sub06SignUp(props) {
    ...
    const onChangeUserPw1=(e)=>{
        ...
        const regExp1 = /^(.){10,}$/g;
        const regExp2 = /^(?![a-zA-Z]+$)(?!\d+$)(?![!@#$%^&*()_\-+=[\]{};:'",.<>/?\\|`~]+$)[a-zA-Z0-9!@#$%^&*()_\-+=[\]{};:'",.<>/?\\|`~]$/;
        ...
        if(regExp1.test(비밀번호)===false){
            ...
            비밀번호오류메시지 = '영문/숫자/특수문자(공백 제외)만 허용하며, 2개 이상 조합';
        }
        ...
        if(state.생년==='' && state.생월 ==='' && state.생일===''){
            ...
            switch(true){
                case String(생년).length < 4:  // 문자열 길이
                    ...
                    break;
                case 생년 > 현재년도:
                    생년월일오류메시지 ='미래의 년도  생년월일이 미래로 입력 되었습니다.';
                    break;
                case 생년 >= (현재년도-14):
                    생년월일오류메시지 ='만 14세 미만은 가입이 불가합니다.';
                    break;
                case 생년 < (현재년도-100):
                    생년월일오류메시지 ='생년월일을 다시 확인해주세요. 죄송합니다. 100세 초과는 가입불가합니다.';
                    break;
                case 생월 < 1 ||  생월 > 12:
        ...
        if(e.target.checked){ // 체크되면
            if( e.target.value==="무료배송, 할인쿠폰 등 혜택/정보 수신 동의(선택)"){
                ...
                if(이용약관동의.includes('이메일')===true){
                    이용약관동의 = [...이용약관동의,  '무료배송, 할인쿠폰 등 혜택/정보 수신 동의(선택)']
                }
            }
    ...
    useEffect(()=>{
        ...
        const cnt = state.이용약관동의.filter((item)=>item.includes('필수')).length;
    ...
    const onSubmitSignUpForm=(e)=>{
        ...
        const {
            아이디,아이디중복확인,비밀번호,비밀번호확인,이름,이메일,이메일중복확인,
            휴대폰,휴대폰인증번호성공,주소1,주소2,이용약관동의,이용약관동의필수항목갯수
        } = state;
        ...
        const switchData = [
            ...
            {조건: 비밀번호!==비밀번호확인, 메시지: "비밀번호와 비밀번호확인 번호는 일치해야 합니다.\n다시 입력하고 시도하세요"},
            {조건: 이름==='', 메시지: "이름을 입력하세요"},
            {조건: 이메일==='', 메시지: "이메일을 입력하세요"},
            {조건: 이메일중복확인===false, 메시지: "이메일중복확인 검사를 하세요"},
            {조건: 휴대폰==='', 메시지: "휴대폰 번호를 하세요"},
            {조건: 휴대폰인증번호성공===false, 메시지: "휴대폰 인증받기를 클릭 하세요"},
            {조건: 주소1===null || 주소2===null, 메시지: "주소를 검색하여 등록하세요"},
            {조건: 이용약관동의필수항목갯수 < 3, 메시지: "이용약관동의 필수 3개를 선택하세요"},
        ]
        ...
        // 폼데이터 
        const 휴대폰형식포멧 = 휴대폰.replace(/^(\d){3}(\d){3,4}(\d){4}$/g,'$1-$2-$3')
        const 주소 = `${주소1} ${주소2}`;
                  ...
                  <form onSubmit={onSubmitSignUpForm} autoComplete="off">
                      <ul>
                          <li className="row row1 block1">
                              <div className="gap">
                                  <label htmlFor="userId"><strong>아이디</strong> <i>*</i></label>
                                  <input 
                                      type="text" 
                                      name="userId" 
                                      id="userId" 
                          ...
                          <li className="row row2 block1">
                              <div className="gap">
                                  <label htmlFor="userPw1"><strong>비밀번호</strong> <i>*</i></label>
                                  <input 
                                      type="password" 
                                      name="userPw1" 
                                      id="userPw1" 
                                  ...
                                  />
                                  {
                                     state.비밀번호오류메시지 !=='' && <p>{state.비밀번호오류메시지}</p>
                                  }
                              </div>
                          </li>
                          <li className="row row3 block1">
                              <div className="gap">
                                  <label htmlFor="userPw2"><strong>비밀번호확인</strong> <i>*</i></label>
                                  <input 
                                      type="password" 
                                      name="userPw2" 
                                      id="userPw2" 
                                  ...
                                  />                                       
                                  {
                                      state.비밀번호확인오류메시지!=='' && <p>{state.비밀번호확인오류메시지}</p>
                                  }
                              </div>
                          </li>
                          <li className="row row4 block1">
                              <div className="gap">
                                  <label htmlFor="userName"><strong>이름</strong> <i>*</i></label>
                                  <input 
                                      type="text" 
                                      name="userName" 
                                      id="userName" 
                                  ...
                                  />
                                  {
                                      state.이름오류메시지!=='' && <p>{state.이름오류메시지}</p>
                                  }
                              </div>
                          </li>
                          <li className="row row5 block1">
                              <div className="gap">
                                  <label htmlFor="userEmail"><strong>이메일</strong> <i>*</i></label>
                                  <input 
                                      type="text" 
                                      name="userEmail" 
                                      id="userEmail" 
                                  ...
                                  />
                                  <button
                                      onClick={onClickUserEmailCheck}
                                  >중복확인</button>
                                  {
                                      state.이메일오류메시지 !== '' &&  <p>{state.이메일오류메시지}</p>
                                  }
                              </div>
                          </li>
                          <li className="row row6 block1">
                              <div className="gap">
                                  <label htmlFor="userHp"><strong>휴대폰</strong> <i>*</i></label>
                                  <input 
                                      type="text" 
                                      name="userHp" 
                                      id="userHp" 
                                  ...
                                  >{state.버튼텍스트}</button>
                                  {
                                    state.휴대폰오류메시지 !=='' &&  <p>{state.휴대폰오류메시지}</p>
                                  }
                              </div>
                          {
                              state.인증번호 !== null &&
                              <div className="gap"> 
                                  ...
                                  <button onClick={onClickUserHpAuthen}>인증번호확인</button>
                          ...
                          <li className="row row7 block1">
                          {
                              ...
                              <div className="gap address-find">
                                  <label htmlFor="userAddress1"><strong>주소</strong> <i>*</i></label>
                                  <a href="!#" onClick={onClickAddressSearch}><i className="bi bi-search"></i> <span>주소검색</span></a>
                                  <p style={{color:'#444'}}>배송지에 따라 상품 정보가 달라질 수 있습니다.</p>
                              </div>
                          }
                          {
                              state.주소1 !== null && 
                              <>
                                  <div className="gap address-completed  address-completed1">
                                      ...
                                      />
                                      <button 
                                          onClick={onClickArressReSerch}
                                      ><i className="bi bi-search"></i>  재검색</button>
                                  </div>
                          ...
                          <li className="row row8 block1">
                              <div className="gap">
                                  <label htmlFor="userMale"><strong>성별</strong> </label>
                          ...
                          <li className="row row9 block1">
                              <div className="gap">
                                  <label htmlFor="userYear"><strong>생년월일</strong>  <i>*</i></label>
                          ...
                          <li className="row row10 line">       
                          </li>
                          <li className="row row11 block2"> 
                              <div className="gap">
                                  <label htmlFor="chkAll"><strong>이용약관동의<i>*</i></strong> </label>
                                          ...
                                          <li>
                                              <label>
                                                  <input 
                                                      ...
                                                      checked={state.이용약관동의.length===state.이용약관.length}
                                                      value='전체 동의합니다.'
                                                  />
                                                  <em>전체 동의합니다.</em>
                                              </label>
                                          ...
                                          </li>
                                      {
                                          state.이용약관.map((item, idx)=>
                                              <li 
                                                  ...
                                                  data-key={item}
                                                  style={{
                                                      ...(item.includes('SNS') ? {float: 'left', width: 'auto', margin: '0 30px 0 40PX'} : {}),
                                                      ...(item.includes('이메일') ? {float: 'left', width: 'auto'} : {}),
                                                      ...(item.includes('본인') ? {clear: 'left'} : {})
                                                  }}
                                              >
                                                  <label>
                                                      <input
                                                  ...
                                                  <span>{item.includes('SNS') || item.includes('이메일') ? '' : '('}{item.split('(')[1]}</span>
                                              </li>
                                          )
                                      }
                                      </ul>
